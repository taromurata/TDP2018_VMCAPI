...
class RealizedEntity(VapiInterface):
    ...
    def get(self,
        ...
        :type  realized_path: :class:`str` or ``None``
        :param realized_path: String Path of the realized object (optional)
...
class Status(VapiInterface):
    ...
    def get(self,
        ...
        """
        Get consolidated status of an intent object, specified by path in query
        parameter
...
class _RealizedEntityStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for get operation
        get_input_type = type.StructType('operation-input', {
            'realized_path': type.OptionalType(type.StringType()),
        })
        get_error_dict = {
            'com.vmware.vapi.std.errors.service_unavailable':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'),
