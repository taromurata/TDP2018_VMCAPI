...
#
# vAPI stub file for package com.vmware.vmc.orgs.sddcs.networks.edges.statistics.interfaces.
#---------------------------------------------------------------------------
...
class Internal(VapiInterface):
    ...
    def __init__(self, config):
        ...
        """
        VapiInterface.__init__(self, config, _InternalStub)
    ...
    def get(self,
        ...
        """
        Retrieve internal interface statistics for a management or compute
        gateway (NSX Edge).
...
class Uplink(VapiInterface):
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _UplinkStub)
...
class _InternalStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vmc/api/orgs/{org}/sddcs/{sddc}/networks/4.0/edges/{edgeId}/statistics/interfaces/internal',
            path_variables={
                'org': 'org',
                'sddc': 'sddc',
                'edge_id': 'edgeId',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.vmc.orgs.sddcs.networks.edges.statistics.interfaces.internal',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)

class _UplinkStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for get operation
        get_input_type = type.StructType('operation-input', {
            'org': type.StringType(),
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vmc/api/orgs/{org}/sddcs/{sddc}/networks/4.0/edges/{edgeId}/statistics/interfaces/uplink',
            path_variables={
                'org': 'org',
                'sddc': 'sddc',
                'edge_id': 'edgeId',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.vmc.orgs.sddcs.networks.edges.statistics.interfaces.uplink',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
