...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.networks.nat.
#---------------------------------------------------------------------------
...
class NatRules(VapiInterface):
    ...
    def delete(self,
        ...
        :param network_name: Network ID (required)
...
class _NatRulesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/networks/{network-name}/nat/{nat-id}/nat-rules/{nat-rule-id}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/networks/{network-name}/nat/{nat-id}/nat-rules',
            path_variables={
                'network_name': 'network-name',
                'nat_id': 'nat-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.networks.nat.nat_rules',
