...
#
# vAPI stub file for package com.vmware.nsx_policy.infra.domains.edge_communication_maps.
#---------------------------------------------------------------------------
...
class _CommunicationEntriesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/infra/domains/{domain-id}/edge-communication-maps/{edge-communication-map-id}/communication-entries/{communication-entry-id}',
            path_variables={
                'domain_id': 'domain-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/domains/{domain-id}/edge-communication-maps/{edge-communication-map-id}/communication-entries',
            path_variables={
                'domain_id': 'domain-id',
                'edge_communication_map_id': 'edge-communication-map-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.infra.domains.edge_communication_maps.communication_entries',
